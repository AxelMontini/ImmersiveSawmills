...
/**Actually copy-pasted and edited from Immersive Engineering to maintain the best possible cross-mod coding experience = using the same working scheme*/
public class BlockISBase<E extends Enum<E> & BlockISBase.IBlockEnum> extends Block implements IIEMetaBlock
{
    ...
    public BlockISBase(String name, Material material, PropertyEnum<E> mainProperty, Class<? extends ItemBlockISBase> itemBlock, Object... additionalProperties)
    {
        ...
        this.adjustSound();
        ImmersiveSawmills.registerBlockByFullName(this, itemBlock, registryName);
        ISContent.registeredISBlocks.add(this);
        lightOpacity = 255;
    }
    ...
    public BlockISBase setMetaHidden(int... meta)
    {
        for(int i : meta)
    ...
    public BlockISBase setMetaUnhidden(int... meta)
    {
        for(int i : meta)
            if(i>=0 && i<this.isMetaHidden.length)
    ...
    public BlockISBase setHasFlavour(int... meta)
    {
    ...
    public BlockISBase<E> setBlockLayer(BlockRenderLayer... layer)
    {
        this.renderLayers = Sets.newHashSet(layer);
        return this;
    }
    public BlockISBase<E> setMetaBlockLayer(int meta, BlockRenderLayer... layer)
    {
    ...
    public BlockISBase<E> setMetaLightOpacity(int meta, int opacity)
    {
    ...
    public BlockISBase<E> setMetaExplosionResistance(int meta, int resistance)
    {
    ...
    public BlockISBase<E> setNotNormalBlock(int meta)
    {
    ...
    public BlockISBase<E> setAllNotNormalBlock()
    {
        if(metaNotNormalBlock == null)
            metaNotNormalBlock = new boolean[this.enumValues.length];
    ...
    public BlockISBase<E> setOpaque(boolean isOpaque)
    {
        opaqueCube = isOpaque;
        fullBlock = isOpaque;
        return this;
    ...
    {
        return ImmersiveSawmills.modid+":"+name;
    }
    ...
    public abstract static class IELadderBlock<E extends Enum<E> & IBlockEnum> extends BlockISBase<E>
    {
        public IELadderBlock(String name, Material material, PropertyEnum<E> mainProperty,
                             Class<? extends ItemBlockISBase> itemBlock, Object... additionalProperties)
        {
