...
public abstract class BlockISMultiblock<E extends Enum<E> & BlockISBase.IBlockEnum> extends BlockISTileProvider<E> {
    public BlockISMultiblock(String name, Material material, PropertyEnum<E> mainProperty, Class<? extends ItemBlockISBase> itemBlock, Object... additionalProperties) {
